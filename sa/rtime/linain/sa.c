...
int csys_sfront_argc = 13;

char * csys_sfront_argv[13] = {
"sfront",
"-latency",
"0.002",
"-aout",
...
#define ASYS_ICHAN 1L
#define ASYS_ITYPENAME  ASYS_SHORT
#define ASYS_ITYPE  short
long asys_isize = 0;
long ibusidx = 0;

ASYS_ITYPE * asys_ibuf = NULL;
...
#define BUS_input_bus 1
#define ENDBUS_input_bus 2
#define ENDBUS 2
float bus[ENDBUS];
...
#define reverberate1_reverb1_a2_0 0
#define reverberate1_reverb1_a1_0 1
#define reverberate1_reverb1_b2_0 2
#define reverberate1_reverb1_b1_0 3
#define reverberate1_reverb1_b0_0 4
#define reverberate1_reverb1_d1_0 5
#define reverberate1_reverb1_d2_0 6
#define reverberate1_reverb1_g0_3 7
#define reverberate1_reverb1_g0_2 8
#define reverberate1_reverb1_g0_1 9
#define reverberate1_reverb1_g0_0 10
#define reverberate1_reverb1_dline0_3 11
#define reverberate1_reverb1_dline0_2 12
#define reverberate1_reverb1_dline0_1 13
#define reverberate1_reverb1_dline0_0 14
#define reverberate1_reverb1_ap2 15
#define reverberate1_reverb1_ap1 16
#define reverberate1_reverb1_f0 17
#define reverberate1_reverb1_x 18
#define reverberate1_reverb1_return 19
#define reverberate1_ENDVAR 20

#define TBL_reverberate1_reverb1_dline0_3 0
#define TBL_reverberate1_reverb1_dline0_2 1
#define TBL_reverberate1_reverb1_dline0_1 2
#define TBL_reverberate1_reverb1_dline0_0 3
#define TBL_reverberate1_reverb1_ap2 4
#define TBL_reverberate1_reverb1_ap1 5
#define reverberate1_ENDTBL 6

extern void sigint_handler(int);

float reverberate1__sym_reverb1(void);

void reverberate1_ipass(void);
void reverberate1_kpass(void);
void reverberate1_apass(void);
...
#define CSYS_PRESETNUM 0

csys_presetstruct csys_presets[1];
...
0, CSYS_SEND_BNUM_0, &(csys_send0_bus[0]) };

#define CSYS_reverberate_VARNUM 0

csys_varstruct csys_reverberate_vars[1];

csys_instrstruct csys_instr[CSYS_INSTRNUM] = {
0, "reverberate",0, CSYS_reverberate_VARNUM, &(csys_reverberate_vars[0]),1, 1 };

struct instr_line e_reverberate[1];
...
#define ASYS_INDRIVER_LINUX
#define ASYS_HASOUTPUT
#define ASYS_HASINPUT
#define ASYS_KSYNC
...
float reverberate1__sym_reverb1(void)
{
   ...
   x =  TB(BUS_input_bus + 0);
   f0 =  4000.0F ;
   va_r0 =  2.0F  ;
   if (NT(TBL_reverberate1_reverb1_ap1).t == NULL)
   {
    i = NT(TBL_reverberate1_reverb1_ap1).len = ROUND(0.005F*ARATE);
    if (i<=0)
   epr(37,"linain.saol","reverb","Library error -- allpass 1");
    NT(TBL_reverberate1_reverb1_ap1).t = (float *) calloc(i,sizeof(float)); 
    i = NT(TBL_reverberate1_reverb1_ap2).len = ROUND(0.0017F*ARATE);
    if (i<=0)
   epr(37,"linain.saol","reverb","Library error -- allpass 2");
    NT(TBL_reverberate1_reverb1_ap2).t = (float *) calloc(i,sizeof(float)); 
   i = NT(TBL_reverberate1_reverb1_dline0_0).len = ROUND(0.030000*ARATE);
   NT(TBL_reverberate1_reverb1_dline0_0).t = (float *) calloc(i,sizeof(float));
   if (va_r0 <= 0)
   epr(37,"linain.saol","reverb","Negative reverberation time");
   NV(reverberate1_reverb1_g0_0) = (float)exp(-0.207233F/va_r0);

   i = NT(TBL_reverberate1_reverb1_dline0_1).len = ROUND(0.034300*ARATE);
   NT(TBL_reverberate1_reverb1_dline0_1).t = (float *) calloc(i,sizeof(float));
   if (va_r0 <= 0)
   epr(37,"linain.saol","reverb","Negative reverberation time");
   NV(reverberate1_reverb1_g0_1) = (float)exp(-0.236936F/va_r0);

   i = NT(TBL_reverberate1_reverb1_dline0_2).len = ROUND(0.039300*ARATE);
   NT(TBL_reverberate1_reverb1_dline0_2).t = (float *) calloc(i,sizeof(float));
   if (va_r0 <= 0)
   epr(37,"linain.saol","reverb","Negative reverberation time");
   NV(reverberate1_reverb1_g0_2) = (float)exp(-0.271475F/va_r0);

   i = NT(TBL_reverberate1_reverb1_dline0_3).len = ROUND(0.045000*ARATE);
   NT(TBL_reverberate1_reverb1_dline0_3).t = (float *) calloc(i,sizeof(float));
   if (va_r0 <= 0)
   epr(37,"linain.saol","reverb","Negative reverberation time");
   NV(reverberate1_reverb1_g0_3) = (float)exp(-0.310849F/va_r0);
   ...
   e = 3.141593F*f0*ATIME;
     ...
     NV(reverberate1_reverb1_b0_0)= 1.0F/(1.0F + 1.414214F*c + c*c);
     NV(reverberate1_reverb1_b1_0)= 2.0F*NV(reverberate1_reverb1_b0_0);
     NV(reverberate1_reverb1_b2_0)= NV(reverberate1_reverb1_b0_0);
     NV(reverberate1_reverb1_a1_0)= 2.0F*NV(reverberate1_reverb1_b0_0)*(1.0F - c*c);
     NV(reverberate1_reverb1_a2_0)= NV(reverberate1_reverb1_b0_0)*(1.0F - 1.414214F*c + c*c);

   }
   i = NT(TBL_reverberate1_reverb1_ap1).tend;
   apout1 = NT(TBL_reverberate1_reverb1_ap1).t[i] - x*0.7F;
   NT(TBL_reverberate1_reverb1_ap1).t[i] = apout1*0.7F + x;
   NT(TBL_reverberate1_reverb1_ap1).tend= ++i;
   if (i==NT(TBL_reverberate1_reverb1_ap1).len)
    NT(TBL_reverberate1_reverb1_ap1).tend=0;
   i = NT(TBL_reverberate1_reverb1_ap2).tend;
   apout2 = NT(TBL_reverberate1_reverb1_ap2).t[i] - apout1*0.7F;
   NT(TBL_reverberate1_reverb1_ap2).t[i] = apout2*0.7F + apout1;
   NT(TBL_reverberate1_reverb1_ap2).tend= ++i;
   if (i==NT(TBL_reverberate1_reverb1_ap2).len)
    NT(TBL_reverberate1_reverb1_ap2).tend=0;

   ret = 0.0F;
   csum = 0.0F;
   i = NT(TBL_reverberate1_reverb1_dline0_0).tend;
   csum += NT(TBL_reverberate1_reverb1_dline0_0).t[i];
   NT(TBL_reverberate1_reverb1_dline0_0).t[i] = NT(TBL_reverberate1_reverb1_dline0_0).t[i]*NV(reverberate1_reverb1_g0_0)+apout2;
   NT(TBL_reverberate1_reverb1_dline0_0).tend = ++i;
   if (i==NT(TBL_reverberate1_reverb1_dline0_0).len)
   NT(TBL_reverberate1_reverb1_dline0_0).tend=0;

   i = NT(TBL_reverberate1_reverb1_dline0_1).tend;
   csum += NT(TBL_reverberate1_reverb1_dline0_1).t[i];
   NT(TBL_reverberate1_reverb1_dline0_1).t[i] = NT(TBL_reverberate1_reverb1_dline0_1).t[i]*NV(reverberate1_reverb1_g0_1)+apout2;
   NT(TBL_reverberate1_reverb1_dline0_1).tend = ++i;
   if (i==NT(TBL_reverberate1_reverb1_dline0_1).len)
   NT(TBL_reverberate1_reverb1_dline0_1).tend=0;

   i = NT(TBL_reverberate1_reverb1_dline0_2).tend;
   csum += NT(TBL_reverberate1_reverb1_dline0_2).t[i];
   NT(TBL_reverberate1_reverb1_dline0_2).t[i] = NT(TBL_reverberate1_reverb1_dline0_2).t[i]*NV(reverberate1_reverb1_g0_2)+apout2;
   NT(TBL_reverberate1_reverb1_dline0_2).tend = ++i;
   if (i==NT(TBL_reverberate1_reverb1_dline0_2).len)
   NT(TBL_reverberate1_reverb1_dline0_2).tend=0;

   i = NT(TBL_reverberate1_reverb1_dline0_3).tend;
   csum += NT(TBL_reverberate1_reverb1_dline0_3).t[i];
   NT(TBL_reverberate1_reverb1_dline0_3).t[i] = NT(TBL_reverberate1_reverb1_dline0_3).t[i]*NV(reverberate1_reverb1_g0_3)+apout2;
   NT(TBL_reverberate1_reverb1_dline0_3).tend = ++i;
   if (i==NT(TBL_reverberate1_reverb1_dline0_3).len)
   NT(TBL_reverberate1_reverb1_dline0_3).tend=0;

   csum *= 0.25F;
   fout = NV(reverberate1_reverb1_b0_0)*csum + NV(reverberate1_reverb1_d2_0);
   NV(reverberate1_reverb1_d2_0)=NV(reverberate1_reverb1_d1_0)-NV(reverberate1_reverb1_a1_0)*fout+NV(reverberate1_reverb1_b1_0)*csum;
   NV(reverberate1_reverb1_d1_0) = -NV(reverberate1_reverb1_a2_0)*fout+NV(reverberate1_reverb1_b2_0)*csum;
   ret += fout;
   return((NV(reverberate1_reverb1_return) = ret));
...
memset(&(NV(0)), 0, reverberate1_ENDVAR*sizeof(float));
memset(&(NT(0)), 0, reverberate1_ENDTBL*sizeof(struct tableinfo));
...
TB(BUS_output_bus + 0) +=  3.0F  * reverberate1__sym_reverb1(NSP) +  10.0F  *  TB(BUS_input_bus + 0);
}
...
e_reverberate[0].noteon = TOBEPLAYED;
e_reverberate[0].starttime = 0.0F;
e_reverberate[0].abstime = 0.0F;
e_reverberate[0].released = 0;
e_reverberate[0].turnoff = 0;
e_reverberate[0].time = 0.0F;
e_reverberate[0].itime = 0.0F;
e_reverberate[0].sdur = -1.0F;
e_reverberate[0].kbirth = kbase;
e_reverberate[0].numchan = midimasterchannel;
...

{
   ...
   if (ibusidx < asys_isize)
    for(busidx=BUS_input_bus;busidx<BUS_input_bus+1;busidx++)
      TB(busidx) = 3.051851e-5F*asys_ibuf[ibusidx++];
   else
   {
    ibusidx = 0;
    if (asys_getbuf(&asys_ibuf, &asys_isize)||(!asys_isize))
     {
       asys_isize = 0;
       for(busidx=BUS_input_bus;busidx<BUS_input_bus+1;busidx++)
       TB(busidx) = 0.0F;
...

{
  ...
  e_reverberate[0].noteon = PLAYING;
  e_reverberate[0].notestate = nextstate;
  e_reverberate[0].endtime = MAXENDTIME;
  e_reverberate[0].nstate = &ninstr[nextstate];
  ninstr[nextstate].iline = &e_reverberate[0];
       oldstate = nextstate;
   ...
   if (asys_iosetup((int)ARATE, ASYS_ICHAN, ASYS_OCHAN, ASYS_ITYPENAME, ASYS_OTYPENAME,"linux", "linux",ASYS_TIMEOPTION) != ASYS_DONE)
   epr(0,NULL,NULL,"audio i/o device unavailable");
   endkcycle = kbase + (int) 
      (KRATE*(endtime - scorebase)*(60.0F/tempo));

 if ((asys_getbuf(&asys_ibuf, &asys_isize) != ASYS_DONE)
     || (!asys_isize))
